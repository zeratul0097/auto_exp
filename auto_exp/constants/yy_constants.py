...
TOP_BOOK_TIME_URL = 'https://truyenyy.vn/kim-thanh-bang/?year={0}&month={1}&page={2}'

# Genre
GENRE_URL = '//a[@class="genre" and starts-with(@href,"/truyen-")]/@href'
GENRE_PAGE_URL = 'https://truyenyy.vn/{0}/danh-sach/?page={1}'
GENRE_LIST_URL = 'https://truyenyy.vn/{0}/danh-sach/'
